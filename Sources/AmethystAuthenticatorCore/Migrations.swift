...
public typealias Account = AAuthenticatorModelSchema_V0_2_0.Account

public enum AAuthenticatorMigrations: SchemaMigrationPlan {
    public static let schemas: [any VersionedSchema.Type] = [AAuthenticatorModelSchema_V0_1_0.self, AAuthenticatorModelSchema_V0_2_0.self]
    
    public static let stages: [MigrationStage] = [v0_1_0tov0_2_0]
